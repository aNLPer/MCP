...
cate2charge = {"社会公共安全":["非法制造枪支罪", "非法买卖枪支罪", "非法持有枪支罪"],
               "市场经济秩序":['假冒注册商标罪',"销售假冒注册商标的商品罪", "合同诈骗罪", "非法经营罪"],
               "公民的人身、民主权利":["故意杀人罪", "故意伤害罪", "非法拘禁罪"],
               "财产权利":["抢劫罪", "诈骗罪", '敲诈勒索罪'],
               "社会管理秩序":['招摇撞骗罪', "聚众斗殴罪", "寻衅滋事罪", "窝藏、包庇罪", "掩饰、隐瞒犯罪所得罪",
...
params = {"epoch":20,
          "batch_size":4,
          "lr":0.00005,
          "model_name":["Base","BaseWP","BaseWE","BaseWEE"],
